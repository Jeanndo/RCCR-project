...
const Auth = (props) => {
  ...
  const authSubmitHandler = async (event) => {
    ...
    if (isLoginMode) {
      try {
        console.log(formState.inputs.password.value, " <<<<<< ", formState.inputs.email.value)
        const responseData = await sendRequest(
          "https://akagera-center.herokuapp.com/user/login",
          "POST",
          JSON.stringify({
      ...
      if(localStorage.getItem('user')){
        ...
        alert(responseData.error, " Try again")
      }
      ...
      try {
        const responseData = await sendRequest(
          "https://akagera-center.herokuapp.com/user",
          "POST",
          JSON.stringify({
